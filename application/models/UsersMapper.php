...
class Application_Model_UsersMapper
{
     ...
     *
     * @param Application_Model_Users instance
     * @return void
     */
     ...
     * @return void
     */
    public function insert(Application_Model_Users $model)
    {
    	$data = array(
			'user_id' => $model->getUser_id(),
			'auth_code' => $model->getAuth_code(),
     ...
     */
    public function update(Application_Model_Users $model, $where)
    {
    	$data = array(
			'user_id' => $model->getUser_id(),
			'auth_code' => $model->getAuth_code(),
     ...
     * @return void
     */
    public function map($row, Application_Model_Users $model)
    {
		$model->setUser_id($row->user_id);
		$model->setAuth_code($row->auth_code);
		$model->setIp($row->ip);
		$model->setTimestamp($row->timestamp);
     ...
     *
     * @return array of Application_Model_Users
     */
