...
/**
  ...
  * @since      File available since Release 1.0.1
 */
class Application_Model_AnswersMapper
{
    /**
     ...
     *
     * @return Application_Model_DbTable_Answers
     */
    public function getDbTable()
    {
        if (null === $this->_dbTable) {
            $this->setDbTable('Application_Model_DbTable_Answers');
        }
     ...
     *
     * @param Application_Model_Answers instance
     * @return void
     */
    public function save(Application_Model_Answers $model)
    {
        $data = array(
     ...
     * @return void
     */
    public function insert(Application_Model_Answers $model)
    {
    	$data = array(
			'answer_id' => $model->getAnswer_id(),
			'question_id' => $model->getQuestion_id(),
     ...
     */
    public function update(Application_Model_Answers $model, $where)
    {
    	$data = array(
			'answer_id' => $model->getAnswer_id(),
			'question_id' => $model->getQuestion_id(),
     ...
     * @param Application_Model_Answers $model
     * @return void
     */
    public function map($row, Application_Model_Answers $model)
    {
     ...
     *
     * @param $id
     * @return Application_Model_Answers
     */
     ...
     *
     * @return array of Application_Model_Answers
     */
