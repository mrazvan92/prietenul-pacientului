...
class Application_Model_CountyMapper
{
     ...
     *
     * @return Application_Model_DbTable_County
     */
     ...
     *
     * @param Application_Model_County instance
     * @return void
     */
    public function save(Application_Model_County $model)
    {
        $data = array(
     ...
     * @return void
     */
    public function insert(Application_Model_County $model)
    {
    	$data = array(
			'county_id' => $model->getCounty_id(),
			'county' => $model->getCounty()
     ...
     */
    public function update(Application_Model_County $model, $where)
    {
    	$data = array(
			'county_id' => $model->getCounty_id(),
			'county' => $model->getCounty()
     ...
     * @param Application_Model_County $model
     * @return void
     */
    public function map($row, Application_Model_County $model)
    {
		$model->setCounty_id($row->county_id);
		$model->setCounty($row->county);
     ...
     *
     * @param $id
     * @return Application_Model_County
     */
    public function find($id)
    {
        ...
        $model = new Application_Model_County();
     ...
     *
     * @return array of Application_Model_County
     */
